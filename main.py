# main.py — النسخة النهائية AI-Core-Engine-Live (مع دمج Xtream Router)
...
# === استيراد Xtream Router (الجديد) ===
from engine.xtream_proxy import router as xtream_router

APP_TITLE = "النواة الذكية الاحترافية – Bassam"
app = FastAPI(title=APP_TITLE)

# --- تفعيل Xtream Router بدون التأثير على باقي الخدمات ---
app.include_router(xtream_router)  # يضيف /api/xtream/* (info, streams, play, seg, ...)
...
def home():
    ...
    <body style='font-family:Arial;text-align:center;direction:rtl;margin-top:40px'>
      ...
      <p>
        ...
        <a href='/api/xtream/streams'>🎥 قنوات Xtream (JSON)</a>
      </p>
    </body></html>
    """
